...
class Montecarlo(object):
    ...
    def cars_rented_day(self, p_of_rented_cars):
        ...
        if p_of_rented_cars<self.historical_rented_cars['4']:
            return 4
        if p_of_rented_cars<self.historical_rented_cars['5']:
            return 5
        if p_of_rented_cars<self.historical_rented_cars['6']:
            return 6
        if p_of_rented_cars<self.historical_rented_cars['7']:
            return 7
        if p_of_rented_cars<self.historical_rented_cars['8']:
            return 8
